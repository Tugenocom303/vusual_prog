    ...
    describe('Тесты на корректных входных данных', () => {
        it('должен преобразовывать CSV с числами и строками', () => {
            ...
            expect(result).toEqual([
                { id: 1, name: 'Кирилл', age: 20, active: 'true' },
                { id: 2, name: 'Даниил', age: 17, active: 'false' },
        ...
        it('должен обрезать пробелы вокруг значений', () => {
            ...
            expect(result).toEqual([
                { id: 1, name: 'Кирилл', age: 20 },
                { id: 2, name: 'Даниил', age: 17 }
            ]);
        });
...
describe('formatCSVFileToJSONFile', () => {
    ...
    it('должен обрабатывать файл с запятой как разделителем', async () => {
        ...
        expect(writeFile).toHaveBeenCalledWith(
            'output.json',
            JSON.stringify([
                { name: 'Кирилл', age: 20, city: 'Иркутск' },
                { name: 'Даниил', age: 17, city: 'Братск' }
            ], null, 2),
            'utf-8'
        );
    });
